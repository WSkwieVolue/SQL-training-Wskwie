...
-- Select all columns from Product, LargePhoto from ProductPhoto and Description from Product Description
-- Tables: Production.Product, Production.ProductPhoto, Production.ProductDescription
...
-- [Ex. 3.1]
-- Create a function that will calculate the amount of tax that is present in a price
-- Assume 23% tax rate.
...
ALTER PROCEDURE sp_deleteProduct @productID int, @referencedObjectCount int OUTPUT
AS
